...
static const Key keys[] = {
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_s, spawn,
     SHCMD("$HOME/.local/bin/dwl-startup.sh")},
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_C, spawn,
     SHCMD("gtk-launch whatsapp-web")},
    {MODKEY,
     XKB_KEY_F1,
     spawn,
     {.v = (const char *[]){"j4-dmenu-desktop", NULL}}},

    /* volume / player / brightness with swayosd-client */
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_asterisk, spawn,
     SHCMD("swayosd-client --output-volume -15")},
    {MODKEY, XKB_KEY_plus, spawn, SHCMD("swayosd-client --output-volume +5")},
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_plus, spawn,
     SHCMD("swayosd-client --output-volume +15")},
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_M, spawn,
     SHCMD("swayosd-client --output-volume mute-toggle")},
    ...
    {0, XKB_KEY_XF86AudioMicMute, spawn,
     SHCMD("swayosd-client --input-volume mute-toggle")},
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn,
     SHCMD("swayosd-client --output-volume +3")},
    {0, XKB_KEY_XF86AudioLowerVolume, spawn,
     SHCMD("swayosd-client --output-volume -3")},
    {0, XKB_KEY_XF86AudioPrev, spawn,
     SHCMD("swayosd-client --playerctl prev --player auto")},
    {0, XKB_KEY_XF86AudioNext, spawn,
     SHCMD("swayosd-client --playerctl next --player auto")},
    {0, XKB_KEY_XF86AudioPause, spawn,
     SHCMD("swayosd-client --playerctl pause --player auto")},
    {0, XKB_KEY_XF86AudioPlay, spawn,
     SHCMD("swayosd-client --playerctl play --player auto")},
    {0, XKB_KEY_XF86AudioStop, spawn,
     SHCMD("swayosd-client --playerctl stop --player auto")},
    {0, XKB_KEY_XF86MonBrightnessUp, spawn,
     SHCMD("swayosd-client --brightness +15")},
